...
onready var menu_button = finding_nodes('tb_menu')
...
func maximized_behaviour_change():
	if OS.window_maximized:
		...
		window_resize_ctrl.visible = true
#		var maximize_normal = preload('res://Icons/WC_Maximize.png')
		maximize_button.texture_normal = TL_Icon.maximize_normal
#		var maximize_hover = preload('res://Icons/WC_Maximize_Hover.png')
		maximize_button.texture_hover = TL_Icon.maximize_hover
#		var maximize_pressed = preload('res://Icons/WC_Maximize_Pressed.png')
		maximize_button.texture_pressed = TL_Icon.maximize_pressed
	elif OS.window_maximized == false:
		window_resize_ctrl.visible = false
		OS.window_maximized = true
#		var windowed_normal = preload('res://Icons/WC_Windowed.png')
		maximize_button.texture_normal = TL_Icon.windowed_normal
#		var windowed_hover = preload('res://Icons/WC_Windowed_Hover.png')
		maximize_button.texture_hover = TL_Icon.windowed_hover
#		var windowed_pressed = preload('res://Icons/WC_Windowed_Pressed.png')
		maximize_button.texture_pressed = TL_Icon.windowed_pressed
