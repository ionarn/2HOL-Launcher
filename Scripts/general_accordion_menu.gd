...
#	TL_Node.auto_login.connect("on_value_changed", self, "_on_value_change")
#	TL_Node.hard_to_quit.connect("on_value_changed", self, "_on_value_change")
#	TL_Node.check_spelling.connect("on_value_changed", self, "_on_value_change")
#	TL_Node.live_triggers.connect("on_value_changed", self, "_on_value_change")
#	TL_Node.tutorial_done.connect("on_value_changed", self, "_on_value_change")
#	TL_Node.pause_on_minimize.connect("on_value_changed", self, "_on_value_change")
#	TL_Node.cursor_speed.connect("on_value_changed", self, "_on_value_change")
